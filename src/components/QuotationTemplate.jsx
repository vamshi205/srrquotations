      ...
      >
        ...
        >
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="w-[70mm] ml-4 flex justify-end overflow-visible">
              <img src="/logo.png" alt="Logo" className="w-full object-contain max-h-[28mm]" style={{ transform: 'translateX(35px)' }} onError={(e) => e.target.style.display = 'none'} />
            </div>
          </div>
